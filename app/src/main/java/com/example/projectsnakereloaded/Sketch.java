...
// https://stackoverflow.com/questions/18459122/play-sound-on-button-click-android
    ...
    /**
     * Handles the calculation of the area for the three sub triangles generated by the mouse click / touch
     * on a position.
     * @param p1
     * @param p2
     * @param p3
    ...
    //Todo: Framerate abhänig machen / Überprüfung Rechtschreibung
    /**
